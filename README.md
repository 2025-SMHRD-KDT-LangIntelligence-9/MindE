...
│   ├── forms.js               # 서식 목록·상세·PDF 다운로드 / AI 자동 작성
...
- **AI 서류 작성 도우미** — 서식 목록에서 선택 → AI 채팅으로 필드 자동 입력 → PDF 다운로드 또는 민원 접수로 전송
...
### 관리자
- **대시보드** — 일별·월별 민원 추이 차트, 긴급 민원 목록, 반복 민원 클러스터
...
- 모든 페이지 최소 너비 **1280px** 고정 — 화면 크기에 따라 레이아웃이 변하지 않습니다.
- 반응형 Tailwind 접두사(`md:`, `lg:`, `sm:`) 미사용.
