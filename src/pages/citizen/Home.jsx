...
function Home() {
  ...
  return (
    <CitizenLayout pageTitle="대시보드" activeMenu="home" sidebarColor="#aecdfa">
      {/* 환영 히어로 영역 */}
      <section className="bg-primary/10 rounded-3xl p-10 flex flex-row items-center justify-between gap-6 mb-8">
        <div>
        ...
        <img src={logo} alt="마음이 로고" className="h-48 w-auto drop-shadow-lg" />
      </section>
      ...
      <section className="grid grid-cols-12 gap-6">
        <div className="col-span-8 bg-white rounded-2xl p-8 border border-outline-variant">
        ...
        <div className="col-span-4 bg-white rounded-2xl p-6 border border-outline-variant flex flex-col">
