...
function Landing() {
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-gradient-to-br from-blue-50/30 via-transparent to-indigo-50/30">
      ...
      {/* 네비게이션 */}
      <nav className="shrink-0 flex items-center justify-between h-16 px-8 md:px-14 border-b border-outline-variant/60 bg-blue-50/80 backdrop-blur-md z-50">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* 히어로 그리드 */}
        <div className="flex-1 flex items-center px-8 md:px-14 relative overflow-hidden">
              ...
              <div className="w-[400px] bg-white rounded-2xl border border-outline-variant shadow-xl overflow-hidden">
                ...
                <div className="px-4 py-5 space-y-4 bg-gradient-to-b from-slate-50 to-white">
                  ...
                  <div className="flex gap-2.5">
                    ...
                    <div className="bg-white border border-outline-variant/50 rounded-2xl rounded-tl-sm px-4 py-3 shadow-sm max-w-[260px]">
                      <p className="text-xs text-on-surface leading-relaxed">
                        국가배상법에 따라 보상 신청이 가능합니다! 아래 서류를 준비해 주세요.
                      </p>
        ...
        <div className="shrink-0 border-t border-outline-variant/60 bg-blue-50/80 backdrop-blur-md relative z-10">
          <div className="max-w-6xl mx-auto px-8 md:px-14 grid grid-cols-4 divide-x divide-outline-variant/40">
            {[
              ...
              <div key={f.label} className="flex items-start gap-5 px-8 py-10">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-on-surface-variant mt-1.5 leading-relaxed whitespace-pre-line">{f.desc}</p>
                </div>
              </div>
            ))}
          </div>
