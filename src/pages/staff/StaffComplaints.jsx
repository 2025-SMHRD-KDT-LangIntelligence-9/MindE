              ...
              <div className="flex-1 overflow-y-auto p-3 md:p-6 space-y-3 md:space-y-5">
                ...
                <div className="bg-white rounded-xl border border-outline-variant p-4">
                  ...
                  <textarea
                    ...
                    placeholder="처리 내용, 관련 부서 전달 여부 등을 기록하세요... (담당자만 확인)"
                    rows={4}
                  ...
                  <button
                    ...
                    className="mt-2 w-full bg-[#1e3a5f] text-white text-sm font-bold py-2.5 rounded-xl hover:brightness-110 transition-all flex items-center justify-center gap-1.5 disabled:opacity-40 disabled:cursor-not-allowed"
                  >
